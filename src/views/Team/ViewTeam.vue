            ...
            <v-col cols="12" sm="7" md="9" xl="10" class="py-0 text-left pa-5">
              ...
              >
                ...
                <p class="mt-1 mb-0 google-font mt-0" style="font-size: 110%">
                  {{ teamInfo.bio.length ? teamInfo.bio : "No Data Found" }}
                </p>
...
export default {
  ...
  methods: {
    ...
    getEventsDataHostedByMember() {
      this.isLoading = true;
      TeamServices.getEventsByTeamMember(this.$route.params.id)
        .then((res) => {
          if (res.success) {
