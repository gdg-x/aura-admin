  ...
  <v-container class style="max-width:1600px">
    ...
    <v-row class>
      <v-col>
        <v-toolbar class="elevation-0" style="border:1px solid #e0e0e0;border-radius:5px;">
          ...
          <v-spacer></v-spacer>&nbsp;
          <EditTeam v-if="!isLoading" @editedSuccess="showSnakeBar" :teamData="userData"/>
        </v-toolbar>
      </v-col>
    </v-row>
    ...
    <v-row class="px-0">
      <v-col cols="12" md="7">
        ...
        <v-container v-else style="border:1px solid #e0e0e0;border-radius:5px;background:white;">
          <v-row>
            <v-col class>
              <v-list-item>
                <v-list-item-avatar>
                  <v-img
                    :src="(userData.image && userData.image.length>0)?userData.image:require('@/assets/img/default_avatar.jpg')"
                  ></v-img>
                </v-list-item-avatar>
          ...
          <v-row justify="center" align="center">
            <v-col md="12" class="px-5">
              ...
              <p
                class="google-font"
              >{{ userData.mbnumber && userData.mbnumber.length>0?userData.mbnumber:'Not Found'}}</p>
          ...
          <v-row justify="center" align="center">
            <v-col class="px-5">
              ...
              <v-text-field
                ...
                outlined
              ></v-text-field>
              <v-btn color="indigo" dark depressed @click="updatePassword" :loading="isUpdating">Update Password</v-btn>
            </v-col>
          </v-row>
        </v-container>
      </v-col>
