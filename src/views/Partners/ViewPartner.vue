          ...
          <v-row>
            ...
            <v-col cols="12" sm="7" md="9" xl="10" class="py-5 text-left pa-5">
              ...
              <p class="mt-1 mb-0 google-font mt-0" style="font-size: 110%">
                {{ partnerInfo.des.length ? partnerInfo.des : "Not Available" }}
              </p>
              <div v-if="role == 'Super Admin' || role == 'Admin'">
                ...
                <p class="mt-0 mb-0 google-font mt-0" style="font-size: 110%">
                  {{ partnerInfo.pocemail || "Not Available" }}
                </p>
              </div>
              <p class="mb-0 mt-3">
                <b>Partner ID</b>
...
export default {
  ...
  methods: {
    ...
    getPartnerData() {
      ...
      PartnersServices.getPartnerDetails(this.$route.params.id)
        .then((res) => {
