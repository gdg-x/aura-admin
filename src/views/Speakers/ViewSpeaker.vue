          ...
          <v-row>
            <v-col cols="12" sm="5" md="3" xl="2" class="pa-0 text-center">
              ...
              >
                ...
                <v-card-text class="px-5 pb-5" style="margin-top: -70px">
                  ...
                  <p class="mt-0 mb-0 google-font mt-0" style="font-size: 110%">
                    {{ speakerInfo.city }}, {{ speakerInfo.country }}
                  </p>
            ...
            <v-col cols="12" sm="7" md="9" xl="10" class="py-5 text-left pa-5">
              ...
              <p class="mt-1 mb-0 google-font mt-0" style="font-size: 110%">
                {{
                  speakerInfo.bio && speakerInfo.bio.length
                    ? speakerInfo.bio
                    : "No Data Found"
                }}
              </p>
              ...
              <div v-if="role == 'Super Admin' || role == 'Admin'">
                ...
                <p class="mt-0 mb-0 google-font mt-0" style="font-size: 110%">
                  {{
                    speakerInfo.mbnumber && speakerInfo.mbnumber.length
                      ? speakerInfo.mbnumber
                      : "No Data Found"
                  }}
                </p>
              </div>
              ...
              <p class="mt-1 mb-0 google-font mt-0" style="font-size: 110%">
                ...
                >
                  ...
                  >
                    <v-chip small ripple style="text-transform: uppercase">{{
                      i
                    }}</v-chip>
                  </a>
                </span>
          ...
          <v-row justify="center" align="center" class="pa-3">
            <v-col md="4" class="text-center">
              ...
              <v-btn
                ...
                "
              >
                <v-icon left style="font-size: 150%"
...
export default {
  ...
  methods: {
    getEventsDataBySpeaker() {
      SpeakerServices.getEventsBySpeaker(this.$route.params.id)
        .then((res) => {
          if (res.success) {
    ...
    getSpeakerData() {
      ...
      SpeakerServices.getSpeakerDetails(this.$route.params.id)
        .then((res) => {
