    ...
    <v-row class="my-0 pa-0 px-3">
      ...
      >
        <v-toolbar-title class="google-font mr-3"
          >Features Events</v-toolbar-title
        >
        <v-spacer></v-spacer>
        <AddFeatureEvent
...
export default {
  ...
  components: {
    AddFeatureEvent: () =>
      import("@/components/Events/FeaturesEvents/AddFeatureEvent"),
    Snakebar: () => import("@/components/Common/Snakebar"),
    ClearFeaturedEvents: () =>
      import("@/components/Events/FeaturesEvents/ClearFeaturedEvents"),
  },
  data: () => ({
    search: "",
    snakeBarMessage: "",
