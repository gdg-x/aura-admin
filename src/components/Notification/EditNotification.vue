  ...
  <v-dialog v-model="dialog" width="800" scrollable>
    ...
    <v-card v-if="dialog">
      <v-card-title class="headline google-font" primary-title
        >Edit Notification</v-card-title
      >
      ...
      <v-card-text>
        <v-container fluid>
          <v-row align="center">
            ...
            <v-col cols="12" md="6" class="pa-1 ma-0">
              <v-text-field
                v-model="editDialogData.regLink"
                label="Reg Link"
                type="url"
                outlined
              ></v-text-field>
            ...
            <v-col cols="12" md="6" class="pa-1 ma-0 order-1 order-md-2">
              <v-img
                ...
                max-height="200"
                :src="
                  editDialogData.image.length > 10
                    ? editDialogData.image
